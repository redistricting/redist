...
// Constructor
inline void redist_aList::init_values(List a, NumericVector c1, NumericVector c2, NumericVector p, NumericVector c3, double e, double m, int l) 
{
...
inline void redist_aList::init_values(List a, NumericVector c1, NumericVector c2, NumericVector p, NumericVector c3, double e) 
{
...
inline void redist_aList::set_cdvec(NumericVector c) 
{
...
inline void redist_aList::set_cd_pop_vec(NumericVector c) 
{
...
inline void redist_aList::set_eprob(double e) 
{
...
inline void redist_aList::set_lambda(int l) 
{
...
inline List redist_aList::get_aList() 
{
...
inline NumericVector redist_aList::get_cdvec() 
{
...
inline NumericVector redist_aList::get_cdorigvec() 
{
...
inline NumericVector redist_aList::get_popvec() 
{
...
inline double redist_aList::get_eprob() 
{
...
inline int redist_aList::get_lambda() 
{
...
// Function to generate initial vector of populations
inline NumericVector redist_aList::init_pop(arma::vec cds)
{
...
// Function to modify adjacency list to reflect adjacency only within a particular congressional district
inline List redist_aList::genAlConn(NumericVector cds) 
{
...
// Function to identify which precincts lie on the boundary of a congressional district
inline NumericVector redist_aList::findBoundary(List conList)
{
...
// Function to make unidirectional adjacency list bidirectional
inline List redist_aList::add_ties(List adj_list){
...
// Function to cut edges of adjacency list probabilistically
inline List redist_aList::cut_edges(List aList_con)
{
...
// Function to generate adjacency graph and count clusters
inline int redist_aList::countpartitions(List adj_list) 
{   
...
inline List redist_aList::bsearch_boundary(List adj_list, arma::vec boundary)
{
...
// Function to count number of valid partitions to swap
inline int redist_aList::count_valid(List boundarypart, NumericVector prop_cdvec)
{
...
// Function to draw p for the number of connected components 
inline int redist_aList::draw_p()
{
...
inline List redist_aList::propose_partition(List boundary_cc, NumericVector cds_prop)
{
...
inline List redist_aList::adjcheck_propcd(NumericVector prop_partitions,
...
// Function to do the elimination check
inline int redist_aList::elim_check(NumericVector prop_partition, NumericVector cds)
{
...
// Function to do the split check
inline int redist_aList::split_check(NumericVector prop_partitions, List adjcheck_out, NumericVector cds_prop)
{
...
// Function to update district populations
inline void redist_aList::update_cd_pop_vec(NumericVector prop_partition,
...
// Function to update the edgecut probability
inline void redist_aList::update_eprob(double e)
{
...
// Function to update the metropolis-hastings probability for a swap
inline void redist_aList::update_mhprob(NumericVector prop_partition,
		                 arma::vec cds,		     
		                 int prop_cd)
{
...
// Function to update lambda
inline void redist_aList::update_lambda(double l)
{
...
// Function to accept or reject swaps
inline int redist_aList::mh_decision(double prob)
{
